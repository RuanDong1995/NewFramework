...
public class BaseViewModel extends AndroidViewModel {
     ...
     * @return
     */
    public ApiRequest getTokenRequest(Object params) {
        String token = "";
        LoginUserEvent.LoginUser loginUser = getApplication().getEventManager().getLoginUserEvent().getLoginUser();
        if (loginUser != null) {
            token = loginUser.token == null ? "" : loginUser.token;
        }
        return new ApiRequest(token, params);
    }
}
